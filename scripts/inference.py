...
def generate_image(
    ...
    for i in tqdm(range(num_inference_steps), desc="Sampling"):
        ...
        # Convert to DM variables for UNet
        dm_t, dm_x = sampler._convert_fm_to_dm(fm_t_in, x_in)
        ...
        # Convert epsilon to velocity
        v_pred = sampler._predict_velocity(dm_t, dm_x, eps_pred)
