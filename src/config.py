...
class LoggingConfig:
    ...
    validation_prompts: List[str] = field(default_factory= lambda: [        # TODO: Add captions from the training subset for better validation insights
        "",
        ""
    ])
...
def load_config(yaml_path: Optional[str] = None, cli_args: Optional[list[str]] = None) -> ExperimentConfig:
